        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (password_verify($old_password, $data['user']['password'])) {
                ...
                if ($old_password == $password1) {
                    $this->session->set_flashdata('flash', '<div class="alert alert-danger" role="alert" > old password maches new Password!</div>');
                ...
                $this->session->set_flashdata('flash', '<div class="alert alert-danger" role="alert" > Old Password Wrong ! </div>');
                redirect('user/changePassword');
            }
        }
    }
